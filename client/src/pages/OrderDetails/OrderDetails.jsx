...
function OrderDetails() {
  ...
  const currentStep =
    order.status === "Cancelled" ? 0 : Number(order.statusStep) || 1;
      ...
      <div className="order-details-container">
        ...
        <div
          className={`order-status-card ${
            order.status === "Cancelled" ? "cancelled-order-card" : ""
          }`}
        >
          <div className="status-icon">
            {order.status === "Cancelled" ? <FiXCircle /> : <FiCheckCircle />}
          </div>
